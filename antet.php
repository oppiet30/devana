...
if (isset($_SESSION["user"][0]) && ($_SESSION["user"][4] > 1)) {
	$top_ad = "";
	$bottom_ad = "";
	$bottom_text = "<font face='Fixedsys' color='orange'>Devana created by Busuioc Andrei.</font> Online at <a class='q_link' href='https://linuxassistant.com/devana'>devana</a></br>";
}
function logo($title)
{
