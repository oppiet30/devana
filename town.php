...
<body class="q_body" onLoad="startres()">
	...
	<div align="center">
		...
		<table width="600" border="2" align="center" class="q_table" style="border-collapse: collapse">
			...
			<tr>
				<td class="td_content">
					<?php
					if (!isset($_GET["v"])) {
						if (isset($_SERVER['HTTP_USER_AGENT']) && (strpos($_SERVER['HTTP_USER_AGENT'], 'MSIE') !== false)) $mleft = 0;
						else $mleft = 125;
        ...
        <img src='" . $imgs . $fimgs . "back.jpg' width='640' height='372' style='position:absolute; left:0; top:75;'>";
						...
						if ($data[7]) if ($data[7] == 10) echo "<img src='" . $imgs . $fimgs . "b22.png' style='position:absolute; left:328; top:165;' name='hall'>";
        ...
        <map name='Map'>";
						...
						if ($data[1]) {
							...
							echo "<area shape='rect' coords='80,103,155,147' style='cursor:url(" . $imgs . $fimgs . "cursor.png), auto;' href='lmill.php?town=" . $town[0] . "' onmouseout=\"lmill.src='" . $imgs . $fimgs . "b1.png', showtext('-')\" onmouseover=\"lmill.src='" . $imgs . $fimgs . "b1_.png', showtext('" . $name[0] . "')\">";
						}
						if ($data[2]) {
							$name = explode("-", $buildings[2][2]);
							echo "<area shape='rect' coords='20,150,87,224' style='cursor:url(" . $imgs . $fimgs . "cursor.png), auto;' href='smason.php?town=" . $town[0] . "' onmouseout=\"smason.src='" . $imgs . $fimgs . "b2.png', showtext('-')\" onmouseover=\"smason.src='" . $imgs . $fimgs . "b2_.png', showtext('" . $name[0] . "')\">";
						}
						if ($data[3]) {
							$name = explode("-", $buildings[3][2]);
							echo "<area shape='rect' coords='144,35,216,95' style='cursor:url(" . $imgs . $fimgs . "cursor.png), auto;' href='ifoundry.php?town=" . $town[0] . "' onmouseout=\"ifoundry.src='" . $imgs . $fimgs . "b3.png', showtext('-')\" onmouseover=\"ifoundry.src='" . $imgs . $fimgs . "b3_.png', showtext('" . $name[0] . "')\">";
						}
						...
						if ($data[7]) {
							...
							echo "<area shape='rect' coords='334,105,409,185' style='cursor:url(" . $imgs . $fimgs . "cursor.png), auto;' href='hall.php?town=" . $town[0] . "' onmouseout=\"hall.src='" . $imgs . $fimgs . "b" . $i . ".png', showtext('-')\" onmouseover=\"hall.src='" . $imgs . $fimgs . "b" . $i . "_.png', showtext('" . $name[$j] . " " . $lang['level'] . " " . $data[7] . "')\">";
						}
					...
					for ($i = 0; $i < count($iaq); $i++) {
						...
						if (!$iaq[$i][4]) $what = $lang['from'] . " " . $twn[2] . " " . $lang['to'] . " " . $what;
						else $what = $lang['returnFrom'] . " " . $what . " " . $lang['on'] . " " . $tget[2];
